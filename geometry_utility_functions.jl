...
export displace_point_by_vector
# == VECTORS == #
...
export arc, arc_start_point, arc_end_point, intersect_arcs, 
            offset_arc, get_angular_adjustment_from_offset, 
                arc_bidirectionally_extended_uniform_offset, arc_amplitude_extended_offset, arc_start_angle_extended_offset
# == ARCS == #
# == CIRCLES == #
end
